...
-- -----------------------------------------------------
-- Table `nooshow`.`association`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`association` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `nooshow`.`association_user_map`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`association_user_map` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_association_user_map_association1`
    ...
    REFERENCES `nooshow`.`association` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `nooshow`.`election`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`election` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `nooshow`.`election_vigilance_map`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`election_vigilance_map` (
  `id` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `nooshow`.`candidate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`candidate` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_nominee_election1`
    ...
    REFERENCES `nooshow`.`election` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `nooshow`.`vote`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`vote` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `time` DATETIME NULL,
  ...
  CONSTRAINT `fk_vote_nominee1`
    ...
    REFERENCES `nooshow`.`candidate` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `nooshow`.`election_user_map`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`election_user_map` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `nooshow`.`two_step_verification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nooshow`.`two_step_verification` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
